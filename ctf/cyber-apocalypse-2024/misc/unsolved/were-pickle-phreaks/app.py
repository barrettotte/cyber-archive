...
import inspect, sys
main_modules = [name for name, obj in inspect.getmembers(sys.modules['__main__']) if inspect.ismodule(obj)]
print('main modules:', main_modules)
app_modules = [name for name, obj in inspect.getmembers(sys.modules) if inspect.ismodule(obj)]
print('app modules:', app_modules)
